...
public:
    ...
    PhoneBook(char* fullname):PhoneBook()
    {
    ...
    PhoneBook(char* fullname, long int homephone):PhoneBook(fullname)
    {
        FullName = new char[strlen(fullname) + 1];
        strcpy_s(FullName, strlen(fullname) + 1, fullname);
    ...
    PhoneBook(char* fullname, long int homephone, long int workphone):PhoneBook(fullname, homephone)
    {
        FullName = new char[strlen(fullname) + 1];
        strcpy_s(FullName, strlen(fullname) + 1, fullname);
    ...
    PhoneBook(char* fullname, long int homephone, long int workphone, long int mobilephone):PhoneBook(fullname, homephone, workphone)
    {
        FullName = new char[strlen(fullname) + 1];
        strcpy_s(FullName, strlen(fullname) + 1, fullname);
